...
def apply_attractor_relaxation(x: jnp.ndarray, eta: float = 0.2, num_steps: int = 5) -> jnp.ndarray:
    """
...
def generate_from_prompt(
    ...
    for i, t in enumerate(ddim_timesteps):
        ...
        # --- NEW: Attractor Relaxation ---
        # Apply relaxation to the phase field to enforce structural coherence
        x = apply_attractor_relaxation(x, eta=0.1, num_steps=3)
